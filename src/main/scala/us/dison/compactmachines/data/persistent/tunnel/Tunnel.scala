...
case class Tunnel(pos : BlockPos,
    ...
    override def toString: String =
      s"Tunnel { pos: ${pos.toString}, face: ${face.toString}, type: ${tunnelType.toString}, connectedToItem: $connectedToItem, connectedToFluid: $connectedToFluid, connectedToEnergy: $connectedToEnergy, outgoing: $outgoing}"
